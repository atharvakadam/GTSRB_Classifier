...
class CNN_classifier():
    ...
    def __init__(self, dataset: Dataloader, num_epochs=100,learning_rate=0.001):
        self.tf_sess = tf.Session()
        self.dataset = dataset
        # self.setup_batch_iterator()
        self.build(epochs=num_epochs, learning_rate=learning_rate)
    ...
    def build(self, epochs=50, learning_rate=0.001):
        print("Entered Build")
        ...
        learningRate = LearningRate(self.x, self.y, self.tf_sess, self.loss, self.accuracy, self.dataset, epochs, learning_rate, plot_charts=False)
        self.learning_rate = learningRate.final_learning_rate
        self.optimizer = tf.train.AdamOptimizer(learning_rate=self.learning_rate).minimize(self.loss)
        # print("Optimizer:", self.optimizer)


    def train(self, epochs, limit=3):
        print("Entered train")
...
if __name__ == '__main__':
    ...
    start = datetime.now()
    cnn = CNN_classifier(data, num_epochs=epochs, learning_rate=learning_rate)
    end = datetime.now()
