...
class CNN_classifier_2():
    ...
    def build(self, epochs=50, learning_rate=0.001):
        ...
        learningRate = LearningRate(self.x, self.y, self.tf_sess, self.loss, self.accuracy, self.dataset, epochs,
                                    learning_rate, plot_charts=False)
...
if __name__ == '__main__':
    ...
    start = datetime.now()
    cnn = CNN_classifier_2(data, num_epochs=epochs, learning_rate=learning_rate)
    end = datetime.now()
